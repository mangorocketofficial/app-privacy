...
원펀 시리즈 앱의 개인정보처리방침을 GitHub Pages로 호스팅합니다.

## URL
- Index: https://mangorocketofficial.github.io/app-privacy/

## 앱별 정책 URL
- 제빵기능사 (`com.onepunch.jebbanggineungsa`): https://mangorocketofficial.github.io/app-privacy/jebbanggineungsa/
- 바리스타 2급 (`com.onepunch.barista2`): https://mangorocketofficial.github.io/app-privacy/barista2/
- 미용사 피부 (`com.onepunch.beautyskin`): https://mangorocketofficial.github.io/app-privacy/beautyskin/
- 컴퓨터활용능력1급 (`com.onepunch.computer1`): https://mangorocketofficial.github.io/app-privacy/computer1/
...
## GitHub Pages 활성화
1. GitHub에서 이 repo를 생성
2. 본 폴더(`_privacy_pages/`)의 모든 파일을 repo 루트로 push
3. Settings → Pages → Source: `main` branch / `/ (root)` → Save
4. 잠시 후 위 URL에 접속하여 동작 확인
